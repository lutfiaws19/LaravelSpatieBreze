    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->role === 'Admin')
                <x-responsive-nav-link :href="route('antrian.index')" :active="request()->routeIs('antrian')">
                    {{ __('Antrian') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('pelanggan.index')" :active="request()->routeIs('pelanggan')">
                    {{ __('Pelanggan') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('kerusakan.index')" :active="request()->routeIs('kerusakan')">
                    {{ __('Kerusakan') }}
                </x-responsive-nav-link>
